...
export default class ContenedorGuias extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      data: [
        ...
        {id:8, ruta:"Cosecha",title: "Cosecha", subTitle:"Guía", image:"https://www.infobae.com/new-resizer/E-5eS6rvl_s_WAZXuO2ESrBShEU=/750x0/filters:quality(100)/s3.amazonaws.com/arc-wordpress-client-uploads/infobae-wp/wp-content/uploads/2019/03/29110007/maiz-1.jpg"}, 
        {id:9, ruta:"Postcosecha",title: "Postcosecha", subTitle:"Guía", image:"https://www.agrarheute.com/media/styles/lightbox/public/media/554410/554410.gif?itok=tZ-T_1V_"}, 
      ]
    };
  }
